...
namespace Bonsai.Reactive
{
    ...
    [Description("Subsequently sorts the elements of all the ordered collections in an observable sequence in ascending order according to the specified key.")]
