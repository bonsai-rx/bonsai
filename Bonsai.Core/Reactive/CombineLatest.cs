...
namespace Bonsai.Reactive
{
    ...
    public class CombineLatest
    {
        ...
        {
            return source1.CombineLatest(source2, source3, source4, source5,
        ...
        {
            return source1.CombineLatest(source2, source3, source4, source5, source6,
        ...
        {
            return source1.CombineLatest(source2, source3, source4, source5, source6, source7,
        ...
        {
            return sources.ToArray().SelectMany(xs => xs.CombineLatest());
        }
    }
}
