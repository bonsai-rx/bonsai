...
[assembly: TypeVisualizer(typeof(IplImageOverlay), Target = typeof(MashupSource<ImageMashupVisualizer, IplImageVisualizer>))]
...
namespace Bonsai.Vision.Design
{
    ...
    /// image visualizer.
    /// </summary>
    public class IplImageOverlay : DialogTypeVisualizer
    {
        IplImage color;
