...
namespace Bonsai
{
    public class WorkflowElementType
    {
        public static readonly WorkflowElementType Source = new WorkflowElementType("Source");
        public static readonly WorkflowElementType Filter = new WorkflowElementType("Filter");
        public static readonly WorkflowElementType Projection = new WorkflowElementType("Projection");
        public static readonly WorkflowElementType Sink = new WorkflowElementType("Sink");
        public static readonly WorkflowElementType Combinator = new WorkflowElementType("Combinator");

        private WorkflowElementType(string text)
        {
            Text = text;
        }
        ...
        public static bool MatchType(Type type, WorkflowElementType elementType)
        {
