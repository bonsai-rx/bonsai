...
namespace Bonsai.Reactive
{
    ...
    public class Zip
    {
        ...
        {
            return source.Zip(second, (xs, ys) => Tuple.Create(xs, ys));
        }
        ...
        {
            return source.Zip(source2, source3, (s1, s2, s3) => Tuple.Create(s1, s2, s3));
        }
        ...
        {
            return source.Zip(source2, source3, source4, (s1, s2, s3, s4) => Tuple.Create(s1, s2, s3, s4));
        }
        ...
        {
            return source.Zip(source2, source3, source4, source5,
        ...
        {
            return source.Zip(source2, source3, source4, source5, source6,
        ...
        {
            return source.Zip(source2, source3, source4, source5, source6, source7,
