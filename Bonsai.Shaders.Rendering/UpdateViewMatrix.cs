...
namespace Bonsai.Shaders.Rendering
{
    ...
    public class UpdateViewMatrix : Sink
    {
        ...
        /// </remarks>
        [Description("The name of the camera used to render the scene. If a sequence of view matrices is provided to the operator, this property is optional.")]
        ...
        /// </summary>
        /// <param name="source">
        /// A sequence of <see cref="Matrix4"/> objects representing the view
